      ...
      try {
        if (res.statusCode == 200) {
          ...
          if (regionfileExists) {
            ...
            itemss != null
                ? regionjsonFileContent.addAll(itemss["data"])
                : null;
            ...
            createRegionFile(itemss["data"], dir!, regionfileName);
