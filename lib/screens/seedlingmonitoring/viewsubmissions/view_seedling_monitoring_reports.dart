...
class SeedlingMonitoringViewReports extends StatefulWidget {
  // static const routeName = '/view_page';

  @override
  _SeedlingMonitoringViewReportsState createState() => _SeedlingMonitoringViewReportsState();
}

class _SeedlingMonitoringViewReportsState extends State<SeedlingMonitoringViewReports> {
  var isConnected;
  String? foneID;
        ...
        WillPopScope(
          ...
          child: Scaffold(
            appBar: AppBar( foregroundColor: fPrimaryWhite,
              ...
              title: Text("Seedling Survival Rate Surveys",
                  ...
                  builder: (ctx, snapshot) =>
                      snapshot.connectionState == ConnectionState.waiting
                          ...
                          : Consumer<PersonalFarmerProvider>(
                              child: Center(
                                child: const Text('No seedlings monitored yet.'),
                              ),
