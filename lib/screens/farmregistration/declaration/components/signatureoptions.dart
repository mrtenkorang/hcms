...
class SignatureOptions extends StatefulWidget {
  final String? alreadyVal;
  final onSelectImage;
  final String? profilePicture;

  SignatureOptions(this.onSelectImage, {this.profilePicture, this.alreadyVal});

  @override
  SignatureOptionsState createState() => SignatureOptionsState();
}

class SignatureOptionsState extends State<SignatureOptions> {
  File? _storedImage;
  ...
  // void setbase64Image() {
  //   regSP.setString('base64signature', base64Sig);
  // }
  ...
  Future<void> _takePicture(ImageSource source) async {
    ...
    await regSP?.setString('base64signature', base64Sig);
