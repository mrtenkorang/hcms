...
class TreeRegistrationScreen extends StatefulWidget {
  const TreeRegistrationScreen({super.key, required this.isIndividual});
...
class _TreeRegistrationScreenState extends State<TreeRegistrationScreen> {
  final TreeRegistrationController controller = Get.put(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Tree Registration"),
    ...
    return Column(
      ...
      children: [
        ...
        Obx(() {
          ...
          final hasNonSpecialType = selectedTypes.any(
            (type) =>
                type != 'Woodlot' &&
                type != 'Commercial Plantation' &&
                type != 'Other',
  ...
  void _showRegionSelectionBottomSheet() {
    ...
    debugPrint("SHOW REGION SELECTION BOTTOM SHEET :::::::::::::;;; ${controller.regionsData}");
  ...
  void _showDistrictSelectionBottomSheet() {
    final controller = Get.find<TreeRegistrationController>();
