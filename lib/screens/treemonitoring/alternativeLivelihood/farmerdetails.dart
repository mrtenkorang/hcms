...
import 'package:hcms_revived2/screens/treemonitoring/alternativeLivelihood/activitydetails.dart';
...
class AlternativeFarmer extends StatefulWidget {
  @override
  _AlternativeFarmerState createState() => _AlternativeFarmerState();
}

class _AlternativeFarmerState extends State<AlternativeFarmer> {
  ...
  final _farmerPhoneNum = TextEditingController();
  ...
  void setFPValuesT() {
    regSP?.setString('aLfarmerfirstName', _farmerfirstName.text);
    regSP?.setString('aLfarmerotherName', _farmerotherName.text);
    regSP?.setString('aLfarmersurName', _farmersurName.text);
    regSP?.setString('aLfarmerPhoneNum', _farmerPhoneNum.text);
    regSP?.setString(
        'aLfarmerGender',
        _farmerGender == "male"
            ? 'male'
            : _farmerGender == "female"
                ...
                : '');
    regSP?.setString(
        'aLcomName', boxChecked ? _communityName.text : _community!);
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        titleOne("Enter contact"),
                                        TextFieldWidget(
                                          keyboardType: TextInputType.phone,
                                          maxLength: 10,
                                          decoration: InputDecoration(
                                              labelText: "Enter contact"),
                                          controller: _farmerPhoneNum,
                                          validator: (input) => input!
                                                  .trim()
                                                  .isEmpty
